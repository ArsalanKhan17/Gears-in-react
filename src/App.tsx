  ...
  return (
    <main>
        ...
        <section className="stage-card">
          ...
          <div className="gear-stage">
            <svg viewBox="0 0 750 430" role="img" aria-label="Animated compound gear system">
              ...
              <g className="annotation"><rect x="59" y="342" width="150" height="42" rx="10" /><text x="75" y="360">INPUT</text><text x="75" y="376">1 rotation / sec</text></g><g className="annotation"><rect x="526" y="46" width="156" height="42" rx="10" /><text x="542" y="64">OUTPUT</text><text x="542" y="80">{Math.abs(outputSpeed).toFixed(2)} rotations / sec</text></g>
            </svg>
          </div>
      ...
      <section className="concept-card">
        <div className="concept-number">{lesson === 'compound' ? '02' : '01'}</div>
